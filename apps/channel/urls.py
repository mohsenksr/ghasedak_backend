...
urlpatterns = [
    ...
    path('content/<str:channel_id>/', GetChannelContentsApi.as_view(), name='channel-contents'),
    ...
    path('subscription/<str:channel_id>/', GetChannelSubscriptionsApi.as_view(), name='get-subscriptions'),
